...
st.markdown('Body Shape: <Body Shape>, Occasion:<Occasion Type>, Category: Dress. Recommend Multiple and most appropriate and unique meta attributes (at least 3 combination) of Dress attributes for each of the following: Length, Pattern, Neck, Print, Shape, Sleeve length, Sleeve styling.')
# Input from user
